...
export const HeroHeader: React.FC = () => {
  ...
  return (
    <div className="relative overflow-hidden border-b border-slate-200 bg-gradient-to-b from-slate-50 via-white to-white py-10 px-4 sm:px-6">
      ...
      <div className="relative mx-auto max-w-7xl">
        ...
        {/* Top Badge */}
        <div className="inline-flex items-center gap-2 rounded-full border border-cyan-200 bg-cyan-50 px-3.5 py-1 text-xs font-semibold text-cyan-800 shadow-sm">
        ...
        <div className="mt-4 max-w-3xl">
          <h1 className="font-['Outfit'] text-3xl font-extrabold tracking-tight text-slate-900 sm:text-5xl">
            Never Miss a High-Signal <span className="bg-gradient-to-r from-cyan-600 via-teal-500 to-indigo-600 bg-clip-text text-transparent">Opportunity</span> Again.
          </h1>
        ...
        <div className="mt-6 flex flex-wrap items-center gap-4">
          ...
          {/* Engine Mode Pill */}
          <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white shadow-sm px-3.5 py-2 text-xs">
            <ShieldCheck className="h-4 w-4 text-emerald-600" />
            <span className="text-slate-600">
              Engine: <strong className="text-slate-900">Local Smart Heuristic (Privacy-Safe)</strong>
            </span>
          </div>
