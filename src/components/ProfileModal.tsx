        ...
        <div className="glass-panel relative w-full max-w-2xl rounded-3xl p-6 sm:p-8 border-slate-700 shadow-2xl my-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-['Outfit'] text-xl font-bold text-white">Edit Professional Profile</h2>
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl bg-cyan-500/20 border border-cyan-500/40 px-3.5 py-2 text-xs font-semibold text-cyan-300 hover:bg-cyan-500/30 transition-all self-start sm:self-auto"
            >
          ...
          <form onSubmit={handleSubmit} className="mt-6 space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                <label className="text-xs font-semibold text-slate-300">Title / Major / Specialization</label>
                <input
              ...
              <div>
                <label className="text-xs font-semibold text-slate-300">Career & Academic Stage</label>
                <select
            ...
            {/* Location Preference */}
            <div>
              <label className="text-xs font-semibold text-slate-300">Preferred Opportunity Location Format</label>
              <select
            ...
            {/* Skills Management */}
            <div>
              <label className="text-xs font-semibold text-slate-300">Core Technical & Professional Skills</label>
