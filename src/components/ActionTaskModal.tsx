...
const PRIORITY_OPTIONS: { value: ActionPriority; label: string; color: string }[] = [
  { value: 'low', label: 'Low', color: 'text-slate-600 bg-slate-100 border-slate-300' },
  ...
  return (
    ...
    >
      <div
        ...
        className="relative w-full max-w-md rounded-2xl border border-slate-200 bg-white shadow-2xl text-slate-900"
      >
        {/* Header */}
        <div className="flex items-center justify-between border-b border-slate-200 px-5 py-4">
          <div>
            <h2
              ...
              className="font-['Outfit'] text-base font-bold text-slate-900"
            >
          ...
          <button
            ...
            className="flex h-7 w-7 items-center justify-center rounded-lg border border-slate-200 bg-slate-50 text-slate-500 hover:text-slate-900 hover:bg-slate-100 transition-colors"
          >
        ...
        <form id="action-task-form" onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="space-y-1.5">
            <label htmlFor="task-title-input" className="block text-xs font-semibold text-slate-700">
            ...
            <input
              ...
              maxLength={500}
              required
              className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-cyan-500 focus:outline-none focus:ring-1 focus:ring-cyan-500"
            />
          </div>

          {/* Description */}
          <div className="space-y-1.5">
            <label htmlFor="task-description-input" className="block text-xs font-semibold text-slate-700">
            ...
            <textarea
              ...
              rows={3}
              className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-sm text-slate-900 placeholder-slate-400 focus:border-cyan-500 focus:outline-none resize-none"
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-1.5">
              <label htmlFor="task-priority-select" className="block text-xs font-semibold text-slate-700">
                <Flag className="inline h-3.5 w-3.5 mr-1 text-indigo-600" />
                Priority
              </label>
              <select
            ...
            <div className="space-y-1.5">
              <label htmlFor="task-due-date-input" className="block text-xs font-semibold text-slate-700">
          ...
          <div className="flex items-center justify-end gap-2 pt-1 border-t border-slate-200">
            <button
              ...
              type="button"
              onClick={handleClose}
              className="rounded-xl border border-slate-200 bg-slate-50 px-4 py-2 text-xs font-semibold text-slate-600 hover:text-slate-900 hover:bg-slate-100 transition-colors"
            >
              Cancel
            </button>
            <button
