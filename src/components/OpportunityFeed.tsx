  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto justify-end">
            ...
            <select
              ...
              className="rounded-xl px-3 py-1.5 text-xs font-medium text-slate-700 border border-slate-300 bg-white focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none"
            >
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3">
          ...
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full rounded-xl pl-10 pr-4 py-2.5 text-xs sm:text-sm bg-white border border-slate-300 text-slate-900 focus:border-cyan-500 focus:ring-1 focus:ring-cyan-500 outline-none"
            />
          </div>

          {/* Location Filter */}
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <span className="text-xs text-slate-500 font-medium shrink-0">Location:</span>
            <select
      ...
      <div className="mt-6 flex items-center justify-between">
        <h2 className="font-['Outfit'] text-xl font-bold text-slate-900 flex items-center gap-2">
        ...
        {isLoadingMatches && (
          <span className="flex items-center gap-1.5 text-xs text-cyan-600 animate-pulse">
      ...
      {sortedOpportunities.length > 0 ? (
        ...
        <div className="mt-12 text-center py-16 rounded-3xl border border-slate-200 bg-white shadow-sm">
          <Sparkles className="mx-auto h-10 w-10 text-slate-400" />
          <h3 className="mt-3 text-lg font-bold text-slate-700">No opportunities match your filters</h3>
          ...
          <button
            ...
            className="mt-4 inline-flex items-center gap-2 rounded-xl bg-cyan-50 border border-cyan-200 px-4 py-2 text-xs font-semibold text-cyan-700 hover:bg-cyan-100"
          >
            Reset All Filters
          </button>
        </div>
